...
# a way for us to implement status uniqueness to avoid subsequent tweets running into ... tweepy.error.TweepError: [{'code': 187, 'message': 'Status is a duplicate.'}]
...
print("---------------------------------------------------------------")
print(
    f"TWEETING AS... @{user.screen_name} ({user.followers_count} FOLLOWERS / {user.friends_count} FOLLOWING)")
print("---------------------------------------------------------------")
